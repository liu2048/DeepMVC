...
_MNIST_DECODERS = [
    encoder.Encoder(input_size=(1, 28, 28), layers="cnn_small_decoder"),  # 修改为有效值
    encoder.Encoder(input_size=(1, 28, 28), layers="cnn_small_decoder"),  # 修改为有效值
]
...
BLOBS_DECODERS = [
    encoder.Encoder(layers="dense_2d_decoder", input_size=(2,)),  # 修改为有效值
    encoder.Encoder(layers="dense_2d_decoder", input_size=(2,)),  # 修改为有效值
]
...
def _caltech_decoder(out_dim):
    return encoder.Encoder(input_size=(out_dim,), layers=[
...
COIL20_DECODERS = [encoder.Encoder(input_size=(1, 64, 64), layers="cnn_large_decoder") for _ in range(3)]  # 修改为有效值
