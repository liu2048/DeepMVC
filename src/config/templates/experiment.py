...
class Experiment(Config):
    ...
    # Model config
    model_parameters: Config  # 重命名字段

    # Number of training runs
    n_runs: int = 2
    # Number of training epochs 100
    n_epochs: int = 30
    # Number of pre-training epochs (only used when pre-training is enabled in model_parameters). 50
    n_pre_train_epochs: int = 20
